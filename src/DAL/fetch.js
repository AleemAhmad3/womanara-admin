...
export const fetchallLeads = async ( page, rowsPerPages) => {
  const reqObj = {
    path: `/api/LeadsList?limit=${rowsPerPages}&page=${page}`,
    method: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("Token")}`,
    },
...
export const fetchallSubscribedUsers = async ( page, rowsPerPages) => {
  const reqObj = {
    path: `/api/SubscriberList?limit=${rowsPerPages}&page=${page}`,
    method: "GET",
    headers: {
      Authorization: `Bearer ${localStorage.getItem("Token")}`,
    },
